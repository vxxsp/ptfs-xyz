    ...
    return (
      <>
        <Navbar bg="dark" variant="dark" sticky="top" expand="lg">
          <Container>
            <Navbar.Brand href="/">
              <img src="/ptfs_wordmark.svg" alt="PTFS Logo" width="100px" />
            </Navbar.Brand>
        ...
        <Router>
          <Switch>
            ...
            <Route exact path="/appeal">
              <Redirect link="https://docs.google.com/forms/d/e/1FAIpQLSf8EUYrPvDNErJ3bkubT6AnF4_Ku3dS-PPyN_VS9PYb8UODvw/viewform" />
            </Route>
            <Route path="*">
              <NoMatch />
            </Route>
